...
df_resultXsl = pd.DataFrame(
    columns=['ID', 'Tumor', 'Stroma', 'Immune', 'Others', 'FileName', 'ImmuneArea', 'ImmuneAvgAnnotations', 'TumorArea',
             'TumorAvgAnnotations', 'StromaArea', 'StromaAvgAnnotations', 'OthersArea', 'OthersAvgAnnotations', 'TumorRatio', 'StromaRatio', 'ImmuneRatio', 'OthersRatio'])
...
for entry in sorted(entries):
    ...
    if "Immune" in entry:
        ...
        df_resultXsl.loc[indexDataFrame] = [annotation_dataframe.iloc[0][0][indexDataFrame],
                                            ...
                                            avgOthersAnnotations, TumorRatio, StromaRatio, ImmuneRatio, OthersRatio]
