...
for entry in entries:
    ...
    if "Immune" in entry :
        ...
        mask_Immune = cv2.imread('/home/marco/Documents/Lab/deepLearning/MaskLou/'+ entry, cv2.IMREAD_GRAYSCALE)
        ...
        mask_Tumor = cv2.imread('/home/marco/Documents/Lab/deepLearning/MaskLou/' + entry.replace('Immune cells', 'Tumor'), cv2.IMREAD_GRAYSCALE)
        print()
